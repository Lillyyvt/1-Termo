# Tratamento de Erros
# Organizar de forma adequada é essencial para evitar erros e garantir que o programa funcione corretamente. 
# O tratamento de erros é uma prática importante para lidar com situações inesperadas que podem ocorrer durante a execução do programa.

# try e except são estruturas usadas para capturar e lidar com erros de forma controlada. 
# O código dentro do bloco try é executado normalmente, mas se ocorrer um erro, o programa pula para o bloco except, onde você pode definir como lidar com o erro.
...
# Exercício 1: 
#Crie um algoritimo para calcular a média e trate o erro ao inserir valores errados.


# while True:
#     try:
#      notaLP = int(input("Digite sua nota de Português:"))
#      notaMAT = int(input("Digite sua nota de Matemática:"))
#      média = (notaMAT + notaLP) / 2
