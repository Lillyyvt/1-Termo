...
# escolha = input("Digite sua forma de acesso")
# print(f"Sua forma de acesso será:" ,escolha)
# for FormaAcesso in escolha:
#       if escolha == "ticket":
#           print("Aperte o botão para emitir o ticket")
#       elif escolha == "tag":
#           print("Acesso liberado!")
#       elif escolha == "Interfone":
#           print("Você está sendo direcionado para o interfone!")
# else:
#     print("Error de usuário!")
# hora_entrada = float(input("Digite sua hora de entrada"))
# ("_____________________//__________________________")

# TempoP = float(input("Digite a hora de saída"))
# ValorC = 2 
# total_permanencia = TempoP - hora_entrada
# total_estacionamento = total_permanencia * ValorC
# print(f"O valor foi de R${total_estacionamento:.2f}"")
