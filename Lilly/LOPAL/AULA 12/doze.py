...
#         messagebox.showwarning("Aviso", "Digite seu nome e idade ★")

#     else:
#         messagebox.showinfo("Bem-Vindo", f"Olá usuário, {nome} de idade {idade} - Seja bem-vindo ao sitema lilly's")
...
# nome_usuario = tk.Entry(janela, font=("Baskerville Old Face", 12))
# nome_usuario.grid(row=0, column=1, padx=10)

# #idade
# idade_usuario = tk.Entry(janela, font=("Baskerville Old Face", 12))
# idade_usuario.grid(row=1, column=1, padx=18)

# btn_mensagem = tk.Button(janela, text="Enter ★ ", command=janela_bemvindo)
# btn_mensagem.grid(row=2, column=0, pady=20, padx=10)
